...
import net.testdriven.psiprobe.tools.logging.jdk.Jdk14HandlerAccessor;
import net.testdriven.psiprobe.tools.logging.log4j.Log4JAppenderAccessor;
import net.testdriven.psiprobe.tools.logging.logback.LogbackAppenderAccessor;
